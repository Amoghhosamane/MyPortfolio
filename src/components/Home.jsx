...
const Home = () => {
  ...
  const gridItems = [
    { category: 'Machine Learning', title: 'Project Alpha', subtitle: 'click here to view projects', link: '#work', image: mlImage },
    { category: 'Web Development', title: 'Project Beta', subtitle: 'click here to view projects', link: '#work', image: webdevImage },
    { category: 'Core Programming', title: 'Project Gamma', subtitle: 'click here to view projects', size: 'col-span-2 h-[800px] max-lg:col-span-1 max-lg:h-[400px]', image: corepgmImage, link: '#work' },
    { category: 'Open Source Contributor 2026', title: '10+ Projects contributed', subtitle: 'many more', size: 'col-span-2 h-[800px] max-lg:col-span-1 max-lg:h-[400px]', image: openImage, link: '#work' },
  ];
